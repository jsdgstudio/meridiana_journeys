              ...
              <div className="space-y-8">
                ...
                <div className="space-y-2">
                  ...
                  <a
                    ...
                    className="inline-flex min-h-11 items-center gap-3 bg-[var(--whatsapp-green)] px-5 py-3 font-sans text-sm text-negro hover:bg-verde hover:text-marfil focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-verde"
                  >
                    {/* WhatsApp icon */}
                    <svg
                      width="16"
