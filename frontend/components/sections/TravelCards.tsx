...
function TravelCard({
  ...
  return (
    <article
      className="tc-card group relative overflow-hidden cursor-pointer min-w-[80px] bg-neutral-900"
      style={{ color: "var(--marfil)", textShadow: "0 1px 14px rgba(0,0,0,0.35)" }}
    >
      {/* Background image */}
      ...
      <div className="tc-scrim-hover absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent" />
      ...
      <div className="tc-content absolute inset-0 p-4 md:p-8 flex flex-col justify-between">
        ...
        <div>
          <div className="tc-collapse">
            <div className="tc-reveal text-[11px] uppercase tracking-[0.2em] mb-4"
          ...
          <h3
            className="tc-title font-display font-light leading-[0.95] mb-4"
            style={{
              color: "var(--marfil)",
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="tc-row flex gap-1.5 w-full"
        ...
        <motion.div
          variants={rowVariants}
          className="tc-row flex gap-1.5 w-full mt-1.5"
      ...
      {/* Espacio de cierre — igual al gap entre cards */}
      <div className="h-1.5" />
